...
3. Build a Kubernetes cluster using [[https://github.com/daljitdokal/raspberry-pi-ubuntu-server-k3s-awx-ansible-automated-setup/tree/ubuntu-server/post-install#install-k3s-and-awx][Ansible with k3s]]
